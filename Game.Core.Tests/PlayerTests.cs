...
{
    [Fact]
    public void Player_Id_IsAutoGenerated()
    {
    ...
    [Fact]
    public void Player_Id_CanBeRestoredFromConstructor()
    {
        var id = Guid.NewGuid();
        var player = new Player(id, "Restored");

        Assert.Equal(id, player.Id);
        Assert.Equal("Restored", player.Name);
    }
